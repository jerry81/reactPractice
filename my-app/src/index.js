...
class Square extends React.Component {
  // React class component - react has many components
  ...
  render() {
    ...
    return (
      ...
      >
        {" "}
        {/* comments in jsx - curly brackets with slash star - className - specifies css class, setState method from React.Component */}
        {this.props.value}
      </button>
    );
  }
